...
```{r}
population_snapshot_loc <- paste0(working_directory,"test/dump/population_profiles.csv")
...
```{r}
cur_data <- filter(population_snapshot_data, SEED==4)
...
ggsave(
  paste0(plot_directory, "task_profiles.pdf"),
  width=15,
  height=10
)
```