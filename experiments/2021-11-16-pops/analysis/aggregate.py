...
def main():
    ...
    if collect_time_series and (time_series_resolution < 1):
    ...
    for run_dir in run_dirs:
        ...
        ##############################
        # update trait cov threshold for certain conditions
        if max_update in [20]:
            trait_cov_thresh = 10
        else:
            trait_cov_thresh = args.trait_cov_thresh
