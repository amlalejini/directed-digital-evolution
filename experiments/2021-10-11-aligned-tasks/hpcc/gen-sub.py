...
combos.register_var("experiment_length")
...
combos.add_val(
    "experiment_length",
    [
        "-EPOCHS 3000 -UPDATES_PER_EPOCH 50",
        "-EPOCHS 1500 -UPDATES_PER_EPOCH 100",
        "-EPOCHS 500 -UPDATES_PER_EPOCH 300",
        "-EPOCHS 300 -UPDATES_PER_EPOCH 500"
    ]
)
...
non_param_values = ["experiment_length"]
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        run_param_info = {key:condition_dict[key] for key in condition_dict if not key in non_param_values }
        run_param_info["OUTPUT_SUMMARY_UPDATE_RESOLUTION"] = "100"
        ...
        run_params += f" {condition_dict['experiment_length']}"
