...
ggsave(
  num_task_profiles_ot_fig,
  filename=paste0(plot_directory, "2021-11-30-num-task-profiles-ts.pdf"),
  width=10,
  height=6
)
```
...
ggsave(
  paste0(plot_directory, "2021-11-30-task-cov-per-n-pops-alt.pdf"),
  width=10,
  height=6
)
```
...
save_plot(
  filename=paste0(plot_directory, "2021-11-30-selection-figure-2.pdf"),
  plot=grid,
  base_height=6,
  base_asp=2.5
