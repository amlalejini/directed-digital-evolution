...
combos.add_val(
    "_MULTI_PARAM_TIMING",
    [
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 20 -UPDATES_PER_EPOCH 20 -EPOCHS 20000",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 50 -UPDATES_PER_EPOCH 50 -EPOCHS 8000",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 100 -UPDATES_PER_EPOCH 100 -EPOCHS 4000",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 200 -UPDATES_PER_EPOCH 200 -EPOCHS 2000",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 500 -UPDATES_PER_EPOCH 500 -EPOCHS 800",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 1000 -UPDATES_PER_EPOCH 1000 -EPOCHS 400",
        "-OUTPUT_SUMMARY_UPDATE_RESOLUTION 2000 -UPDATES_PER_EPOCH 2000 -EPOCHS 200"
    ]
)
